...
const content = {
  en: {
    ...
    description:
      "Register for birth certificate or check existing certificate status",
  ...
  bn: {
    ...
    description:
      "জন্মনিবন্ধনের জন্য নিবন্ধন করুন বা বিদ্যমান সার্টিফিকেটের অবস্থা পরীক্ষা করুন",
...
export default async function BirthCertificatePage({
  params,
}: {
